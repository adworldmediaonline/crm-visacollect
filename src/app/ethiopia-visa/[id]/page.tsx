                    ...
                    <>
                        <Card className="mb-6">
                            <CardHeader className="flex flex-row items-center justify-between">
                                <div>
                                    <CardTitle>Visa Application: {data.reference || id}</CardTitle>
                                    <CardDescription>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                            ...
                            {data.visaDetails && <VisaDetailsCard visaDetails={data.visaDetails} />}
                            {data.arrivalInfo && <ArrivalInfoCard arrivalInfo={data.arrivalInfo} />}
                        </div>

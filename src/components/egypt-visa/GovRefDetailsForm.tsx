...
import { GovRefDetails, VisaApplication } from '@/types/egypt-visa';
...
export function GovRefDetailsForm({
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (data: {
      ...
      applicantType: 'primary' | 'additional';
      additionalApplicantIndex: number | null;
    }) => egyptVisaApi.createOrUpdateGovRefDetails(data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['EgyptVisaApplication', applicationId] });

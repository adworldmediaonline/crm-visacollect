...
import { VisaApplication } from '@/types/egypt-visa';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { ApplicantDetails } from '@/components/egypt-visa/AdditionalApplicants';
import { UserCircle, User } from 'lucide-react';
import { GovRefDetailsForm } from '@/components/egypt-visa/GovRefDetailsForm';
          ...
          {additionalApplicants.map((applicant, index) => (
            <TabsContent key={applicant._id} value={`additional-${index}`}>
              ...
              <ApplicantDetails
                ...
                documents={applicant?.documents || null}
                visaType={visaApplication?.visaDetails?.visaType}
                isPrimary={false}
              />
            </TabsContent>

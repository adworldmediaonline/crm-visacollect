        ...
        <Card>
            ...
            <CardContent className="grid gap-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col space-y-1">
                        <p className="text-sm font-medium text-muted-foreground">Visa Validity</p>
                        <p className="font-medium">{visaDetails.visaValidity}</p>
                    </div>
                    <div className="flex flex-col space-y-1">
                        <p className="text-sm font-medium text-muted-foreground">Visa Fee</p>
                        <p className="font-medium">${visaDetails.visaFee}</p>
                    </div>
                    {visaDetails.companyReferenceNumber && (
                        <div className="flex flex-col space-y-1">
                            <p className="text-sm font-medium text-muted-foreground">Company Reference</p>
                            <p className="font-medium">{visaDetails.companyReferenceNumber}</p>
                        </div>
                    )}
                </div>
            </CardContent>
